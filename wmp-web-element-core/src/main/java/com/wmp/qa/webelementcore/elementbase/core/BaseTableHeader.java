...
import com.wmp.qa.webelementcore.elementbase.behavior.Clickable;
import com.wmp.qa.webelementcore.elementbase.util.KeyBoard;
...
public abstract class BaseTableHeader extends BaseElement {
    ...
    public void waitTillElementVisible(Integer maxWaitTime) {
        this.baseTableHeaderElement = (new WebDriverWait(baseTableHeaderDriver, ofSeconds(maxWaitTime / 1000))).until(ExpectedConditions.presenceOfElementLocated(locator));
    ...
    public boolean verifyElementTextIs(String text) {
        baseTableHeaderElement = (new WebDriverWait(baseTableHeaderDriver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000))).until(ExpectedConditions.elementToBeClickable(locator));
    ...
    public boolean isDisabled() {
        this.baseTableHeaderElement = (new WebDriverWait(baseTableHeaderDriver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000))).until(ExpectedConditions.visibilityOfElementLocated(locator));
    ...
    public boolean isEnabled() {
        this.baseTableHeaderElement = (new WebDriverWait(baseTableHeaderDriver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000))).until(ExpectedConditions.elementToBeClickable(locator));
