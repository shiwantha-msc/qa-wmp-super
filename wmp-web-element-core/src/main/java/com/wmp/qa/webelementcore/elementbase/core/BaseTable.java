...
public abstract class BaseTable extends BaseElement {
    ...
    public boolean isDisabled() {
        this.baseTableElement = (new WebDriverWait(baseTableDriver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000))).until(ExpectedConditions.visibilityOfElementLocated(locator));
    ...
    public boolean isDisplayed() {
        ...
        try {
            this.baseTableElement = (new WebDriverWait(baseTableDriver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000))).until(ExpectedConditions.elementToBeClickable(locator));
