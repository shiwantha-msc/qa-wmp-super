...
public abstract class BaseDateRangePicker extends BaseElement {
    ...
    public void clickPrev() throws ApplicationException, ScriptException {
        try {
            Thread.sleep(1000);
            WebElement prevElement = ((new WebDriverWait(driver, ofSeconds(10)))
    ...
    public void clickNext() throws ApplicationException, ScriptException {
        try {
            Thread.sleep(1000);
            WebElement nextElement = ((new WebDriverWait(driver, ofSeconds(10)))
                    .until(ExpectedConditions.elementToBeClickable(By
    ...
    public void selectDay(Integer date) throws ApplicationException, ScriptException {
        try {
            Thread.sleep(1000);
            WebElement dateElement = ((new WebDriverWait(driver, ofSeconds(10)))
                    .until(ExpectedConditions.elementToBeClickable(By
    ...
    public void selectLastDay() throws ApplicationException, ScriptException {
        try {
            Thread.sleep(1000);
            WebElement lastDayElement = ((new WebDriverWait(driver, ofSeconds(10)))
                    .until(ExpectedConditions.elementToBeClickable(By
    ...
    public void selectYear(Integer year) throws ApplicationException, ScriptException {
        try {
            ...
            WebElement yearElement = ((new WebDriverWait(driver, ofSeconds(10)))
                    .until(ExpectedConditions.elementToBeClickable(By
    ...
    public void selectMonth(Integer month) throws ApplicationException, ScriptException {
        try {
            ...
            if (monthText != null) {
                WebElement monthElement = ((new WebDriverWait(driver, ofSeconds(10)))
                        .until(ExpectedConditions.elementToBeClickable(By
    ...
    private void selectHeader() {
        try {
            Thread.sleep(1000);
            WebElement headerElement = ((new WebDriverWait(driver, ofSeconds(10)))
                    .until(ExpectedConditions.elementToBeClickable(By
