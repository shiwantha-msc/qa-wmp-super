package com.wmp.qa.webelementcore.elementbase.core;
...
import com.wmp.qa.webelementcore.elementbase.behavior.Element;
import com.wmp.qa.webelementcore.elementbase.behavior.Typable;
...
public abstract class BaseElement implements Element {
    ...
    public String getText() throws ApplicationException, ScriptException {
        try{
            this.element = (new WebDriverWait(driver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000))).until(ExpectedConditions.elementToBeClickable(locator));
    ...
    public boolean isDisabled() throws ApplicationException, ScriptException {
        try{
            this.element = (new WebDriverWait(driver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000))).until(ExpectedConditions.visibilityOfElementLocated(locator));
    ...
    public void waitTillElementVisible(Integer maxWaitTime) {
        this.element = (new WebDriverWait(driver, ofSeconds(maxWaitTime / 1000))).until(ExpectedConditions.presenceOfElementLocated(locator));
    ...
    public WebElement getElement() throws ApplicationException, ScriptException {
        try{
            return (new WebDriverWait(driver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000))).until(ExpectedConditions.visibilityOfElementLocated(locator));
        }catch (TimeoutException e) {
            throw new ApplicationException("Time out after waiting for element");
        }catch (InvalidElementStateException e) {
            throw new ApplicationException("Element Not editable");
    ...
    public void waitTillElementClickable(Integer maxWaitTime) throws ApplicationException, ScriptException {
        try{
            this.element = (new WebDriverWait(driver, ofSeconds(maxWaitTime / 1000))).until(ExpectedConditions.elementToBeClickable(locator));
        }catch (TimeoutException e) {
            throw new ApplicationException("Time out after waiting for element");
        } catch (InvalidElementStateException e) {
            throw new ApplicationException("Element Not editable");
    ...
    public void waitTillElementInvisible() throws ApplicationException {
        try{
            WebDriverWait wait = new WebDriverWait(driver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000));
