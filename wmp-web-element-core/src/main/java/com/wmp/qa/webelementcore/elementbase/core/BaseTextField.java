...
public abstract class BaseTextField extends BaseElement {
    ...
    public boolean verifyElementTextIs(String text) {
        baseTextFieldElement = (new WebDriverWait(baseTextFieldDriver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000))).until(ExpectedConditions.elementToBeClickable(locator));
    ...
    public boolean isDisabled() {
        this.baseTextFieldElement = (new WebDriverWait(baseTextFieldDriver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000))).until(ExpectedConditions.visibilityOfElementLocated(locator));
    ...
    public boolean isEnabled() {
        this.baseTextFieldElement = (new WebDriverWait(baseTextFieldDriver, ofSeconds(Constant.TIMEOUT_IMPLICIT / 1000))).until(ExpectedConditions.elementToBeClickable(locator));
